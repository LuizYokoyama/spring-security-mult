package io.github.luizyokoyama.springsecuritymult;
...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT, classes = SpringSecurityMultApplication.class)
public class MultipleAuthProvidersApplicationIntegrationTest {
    ...
    public void givenExternalUsers_whenGetPingWithValidUser_thenOK() {
        ResponseEntity<String> result = makeRestCallToGetPing("user1", "pass");
